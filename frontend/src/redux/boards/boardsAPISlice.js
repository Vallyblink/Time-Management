...
const boardsAPISlice = createSlice({
  ...
  reducers: {
    ...
    setCollums: (state, action) => {
      state.colums = action.payload
    },
...
export const { setCollums,setError,setFilter, clearError, setBoardData, setAllBoards, setBoardsIdArray, setBoardId, setBoardResponse, setContentIndexState, setColumns } = boardsAPISlice.actions;
